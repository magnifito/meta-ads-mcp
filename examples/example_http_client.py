...
class MetaAdsMCPClient:
    ...
    def __init__(self, base_url: str = "http://localhost:8080", meta_access_token: str | None = None):
    ...
    def _make_request(self, method: str, params: dict[str, Any] = None) -> dict[str, Any]:
        ...
        payload = {"jsonrpc": "2.0", "method": method, "id": self.session_id}
    ...
    def initialize(self) -> dict[str, Any]:
        ...
        return self._make_request(
            "initialize",
            {
                ...
                "clientInfo": {"name": "meta-ads-example-client", "version": "1.0.0"},
            },
        )
