...
class CallbackHandler(BaseHTTPRequestHandler):
    ...
    def _handle_oauth_callback(self):
        ...
        if error:
            ...
            token_container.update({"auth_code": code, "state": state, "timestamp": asyncio.get_event_loop().time()})
    ...
    def _handle_token(self):
        ...
        response_data = {"status": "success", "data": token_container}
...
def shutdown_callback_server():
    ...
    global \
        ...
        callback_server_running, \
        callback_server_port, \
        callback_server_instance, \
        server_shutdown_timer
