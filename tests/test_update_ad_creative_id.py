...
class TestUpdateAdCreativeId:
    ...
    async def test_update_ad_creative_id_success(self):
        ...
        sample_response = {"success": True, "id": "test_ad_123"}
    ...
    async def test_update_ad_invalid_creative_id(self):
        ...
        api_error = {"error": {"message": "Invalid creative ID", "type": "OAuthException", "code": 100}}

        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            mock_api.return_value = api_error

            result = await update_ad(ad_id="test_ad_123", creative_id="invalid_creative_999", access_token="test_token")
    ...
    async def test_update_ad_nonexistent_creative_id(self):
        ...
        api_error = {"error": {"message": "Creative does not exist", "type": "OAuthException", "code": 803}}

        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            mock_api.return_value = api_error

            result = await update_ad(
                ad_id="test_ad_123", creative_id="nonexistent_creative_999", access_token="test_token"
            )
    ...
    async def test_update_ad_creative_id_from_different_account(self):
        ...
        api_error = {
            "error": {"message": "Creative does not belong to this account", "type": "OAuthException", "code": 200}
        }
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            result = await update_ad(
                ad_id="test_ad_123", creative_id="other_account_creative_456", access_token="test_token"
            )
    ...
    async def test_update_ad_no_parameters(self):
        ...
        result = await update_ad(ad_id="test_ad_123", access_token="test_token")
    ...
    async def test_update_ad_missing_ad_id(self):
        ...
        result = await update_ad(ad_id="", creative_id="new_creative_456", access_token="test_token")
    ...
    async def test_update_ad_creative_compatibility_validation(self):
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            result = await update_ad(
                ad_id="test_ad_123", creative_id="incompatible_creative_456", access_token="test_token"
            )
