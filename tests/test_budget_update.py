...
class TestBudgetUpdateFunctionality:
    ...
    def mock_api_request(self):
        ...
        with patch("meta_ads_mcp.core.adsets.make_api_request") as mock:
            mock.return_value = {"id": "test_adset_id", "daily_budget": "5000", "status": "ACTIVE"}
            yield mock
    ...
    async def test_budget_update_success(self, mock_api_request, mock_auth_manager, valid_adset_id, valid_daily_budget):
        ...
        result = await update_adset(adset_id=valid_adset_id, daily_budget=valid_daily_budget)
    ...
    @pytest.mark.asyncio
    async def test_lifetime_budget_update_success(
        self, mock_api_request, mock_auth_manager, valid_adset_id, valid_lifetime_budget
    ):
        """Test successful lifetime budget update"""

        result = await update_adset(adset_id=valid_adset_id, lifetime_budget=valid_lifetime_budget)
    ...
    @pytest.mark.asyncio
    async def test_both_budget_types_update(
        self, mock_api_request, mock_auth_manager, valid_adset_id, valid_daily_budget, valid_lifetime_budget
    ):
        """Test updating both daily and lifetime budget simultaneously"""

        result = await update_adset(
            adset_id=valid_adset_id, daily_budget=valid_daily_budget, lifetime_budget=valid_lifetime_budget
        )
    ...
    @pytest.mark.asyncio
    async def test_budget_update_with_other_parameters(
        self, mock_api_request, mock_auth_manager, valid_adset_id, valid_daily_budget
    ):
    ...
    async def test_budget_update_with_zero_budget(self, mock_api_request, mock_auth_manager, valid_adset_id):
        ...
        result = await update_adset(adset_id=valid_adset_id, daily_budget="0")
    ...
    async def test_budget_update_with_high_budget(self, mock_api_request, mock_auth_manager, valid_adset_id):
        ...
        result = await update_adset(adset_id=valid_adset_id, daily_budget=high_budget)
    ...
    @pytest.mark.asyncio
    async def test_budget_update_api_error_handling(
        self, mock_api_request, mock_auth_manager, valid_adset_id, valid_daily_budget
    ):
    ...
    async def test_budget_update_with_negative_budget(self, mock_api_request, mock_auth_manager, valid_adset_id):
        ...
        result = await update_adset(adset_id=valid_adset_id, daily_budget="-1000")
    ...
    async def test_budget_update_with_non_numeric_string(self, mock_api_request, mock_auth_manager, valid_adset_id):
        ...
        result = await update_adset(adset_id=valid_adset_id, daily_budget="invalid_budget")
    ...
    @pytest.mark.asyncio
    async def test_budget_update_with_permission_error(
        self, mock_api_request, mock_auth_manager, valid_adset_id, valid_daily_budget
    ):
    ...
    @pytest.mark.asyncio
    async def test_budget_update_with_targeting(
        self, mock_api_request, mock_auth_manager, valid_adset_id, valid_daily_budget
    ):
        ...
        result = await update_adset(adset_id=valid_adset_id, daily_budget=valid_daily_budget, targeting=targeting)
...
class TestBudgetUpdateIntegration:
    ...
    async def test_budget_update_workflow(self):
        ...
        with (
            patch("meta_ads_mcp.core.adsets.make_api_request") as mock_api,
            ...
            result = await update_adset(adset_id="test_adset_id", daily_budget="5000", lifetime_budget="50000")
