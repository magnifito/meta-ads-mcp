...
class TestInsightsPagination:
    ...
    def mock_paginated_response_page1(self):
        ...
        return {
            ...
            "paging": {
                "cursors": {"before": "before_cursor_1", "after": "after_cursor_1"},
    ...
    def mock_paginated_response_page2(self):
        ...
        return {
            ...
            "paging": {"cursors": {"before": "before_cursor_2", "after": "after_cursor_2"}},
        }

    @pytest.mark.asyncio
    async def test_insights_with_limit_parameter(
        ...
        with patch("meta_ads_mcp.core.insights.make_api_request", new_callable=AsyncMock) as mock_api_request:
            ...
            result = await get_insights(object_id=valid_account_id, level="campaign", time_range="last_30d", limit=2)
    ...
    async def test_insights_with_after_cursor(self, mock_auth_manager, valid_account_id, mock_paginated_response_page2):
        ...
        with patch("meta_ads_mcp.core.insights.make_api_request", new_callable=AsyncMock) as mock_api_request:
            ...
            result = await get_insights(
                object_id=valid_account_id, level="campaign", time_range="last_30d", limit=10, after=after_cursor
            )
    ...
    async def test_insights_default_limit(self, mock_auth_manager, valid_account_id, mock_paginated_response_page1):
        ...
        with patch("meta_ads_mcp.core.insights.make_api_request", new_callable=AsyncMock) as mock_api_request:
            ...
            await get_insights(object_id=valid_account_id, level="campaign")
    ...
    @pytest.mark.asyncio
    async def test_insights_without_after_cursor(
        self, mock_auth_manager, valid_account_id, mock_paginated_response_page1
    ):
    ...
    @pytest.mark.asyncio
    async def test_insights_pagination_with_custom_time_range(
        self, mock_auth_manager, valid_account_id, mock_paginated_response_page1
    ):
        ...
        with patch("meta_ads_mcp.core.insights.make_api_request", new_callable=AsyncMock) as mock_api_request:
            ...
            await get_insights(
                object_id=valid_account_id, level="campaign", time_range=custom_time_range, limit=5, after="test_cursor"
            )
    ...
    @pytest.mark.asyncio
    async def test_insights_pagination_with_breakdown(
        self, mock_auth_manager, valid_account_id, mock_paginated_response_page1
    ):
        ...
        with patch("meta_ads_mcp.core.insights.make_api_request", new_callable=AsyncMock) as mock_api_request:
            ...
            await get_insights(
                object_id=valid_account_id, level="campaign", breakdown="age", limit=10, after="test_cursor_2"
            )
    ...
    @pytest.mark.asyncio
    async def test_insights_paging_response_structure(
        self, mock_auth_manager, valid_account_id, mock_paginated_response_page1
    ):
        ...
        with patch("meta_ads_mcp.core.insights.make_api_request", new_callable=AsyncMock) as mock_api_request:
            ...
            result = await get_insights(object_id=valid_account_id, level="campaign", limit=2)
