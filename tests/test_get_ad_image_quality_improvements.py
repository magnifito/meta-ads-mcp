...
class TestGetAdImageQualityImprovements:
    ...
    async def test_falls_back_to_image_url_when_image_urls_for_viewing_unavailable(self):
        ...
        mock_creative_details = {"id": "creative_123456789", "name": "Test Creative"}
    ...
    async def test_get_ad_image_with_real_world_example(self):
        ...
        mock_ad_data = {"account_id": "act_15975950", "creative": {"id": "606995022142818"}}

        mock_creative_details = {"id": "606995022142818", "name": "Test Creative"}
