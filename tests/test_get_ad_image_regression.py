...
class TestGetAdImageRegressionFix:
    ...
    async def test_get_ad_image_json_parsing_regression_fix(self):
        ...
        mock_ad_data = {"account_id": "act_123456789", "creative": {"id": "creative_123456789"}}

        mock_creative_details = {"id": "creative_123456789", "name": "Test Creative", "image_hash": "test_hash_123"}
                        ...
                        "data": [
                            {
                                "id": "creative_123456789",
                                "name": "Test Creative",
                                "object_story_spec": {"link_data": {"image_hash": "fallback_hash_123"}},
                            }
                        ]
                    }
                )
    ...
    async def test_get_ad_image_parameter_order_regression(self):
        ...
        with (
            ...
            await get_ad_image(access_token="test_token", ad_id="test_ad_id")
    ...
    async def test_get_ad_image_direct_url_download_failure(self):
        ...
        mock_creative_details = {"id": "creative_123456789", "name": "Download Fail Creative"}
    ...
    async def test_get_ad_image_quality_improvement_prioritizes_high_quality(self):
        ...
        mock_creative_details = {"id": "creative_123456789", "name": "Quality Test Creative"}
                ...
                "data": [
                    {
                        ...
                        "object_story_spec": {"link_data": {"picture": "https://example.com/object_story_picture.jpg"}},
                    }
                ]
            }
        )
