...
from meta_ads_mcp.core.ads import create_ad_creative, get_account_pages, search_pages_by_name
...
class TestPageDiscoveryIntegration:
    ...
    async def test_create_ad_creative_no_pages_found(self):
        ...
        mock_discovery_result = {"success": False, "message": "No suitable pages found for this account"}
