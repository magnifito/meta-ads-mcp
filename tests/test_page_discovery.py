...
from meta_ads_mcp.core.ads import _discover_pages_for_account, _search_pages_by_name_core, search_pages_by_name
...
class TestPageDiscovery:
    ...
    async def test_discover_pages_from_tracking_specs(self):
        ...
        mock_ads_data = {"data": [{"id": "123456789", "tracking_specs": [{"page": ["987654321", "111222333"]}]}]}

        mock_page_data = {"id": "987654321", "name": "Test Page", "username": "testpage", "category": "Test Category"}
    ...
    async def test_discover_pages_from_client_pages(self):
        ...
        mock_client_pages_data = {"data": [{"id": "555666777", "name": "Client Page", "username": "clientpage"}]}
    ...
    async def test_discover_pages_from_assigned_pages(self):
        ...
        mock_assigned_pages_data = {"data": [{"id": "888999000", "name": "Assigned Page"}]}
    ...
    async def test_discover_pages_with_invalid_page_ids(self):
        ...
        mock_ads_data = {
            "data": [{"id": "123456789", "tracking_specs": [{"page": ["invalid_id", "not_numeric", "123abc"]}]}]
        }
    ...
    async def test_search_pages_by_name_no_matches(self):
        ...
        mock_pages_data = {"data": [{"id": "111", "name": "Test Page 1"}, {"id": "222", "name": "Another Test Page"}]}
    ...
    async def test_search_pages_by_name_core_no_pages(self):
        ...
        mock_discovery_result = {"success": False, "message": "No pages found"}
    ...
    async def test_discover_pages_with_multiple_page_ids(self):
        ...
        mock_ads_data = {
            "data": [{"id": "123456789", "tracking_specs": [{"page": ["111222333", "444555666", "777888999"]}]}]
        }

        mock_page_data = {"id": "111222333", "name": "First Page", "username": "firstpage"}
    ...
    async def test_discover_pages_with_mixed_valid_invalid_ids(self):
        ...
        mock_ads_data = {
            "data": [
                {"id": "123456789", "tracking_specs": [{"page": ["invalid", "123456789", "not_numeric", "987654321"]}]}
            ]
        }

        mock_page_data = {"id": "123456789", "name": "Valid Page", "username": "validpage"}
