...
class TestGetAccountPages:
    ...
    async def test_get_account_pages_multi_approach_success(self):
        ...
        mock_user_pages = {
            "data": [{"id": "111111111", "name": "Personal Page", "category": "Personal Blog", "fan_count": 100}]
        }

        mock_client_pages = {
            "data": [{"id": "222222222", "name": "Client Page", "category": "Business", "fan_count": 500}]
        }

        mock_adcreatives = {"data": [{"id": "creative_123", "object_story_spec": {"page_id": "333333333"}}]}
        ...
        with (
            patch("meta_ads_mcp.core.auth.get_current_access_token", new_callable=AsyncMock) as mock_auth,
    ...
    async def test_get_account_pages_me_special_case(self):
        ...
        mock_user_pages = {
            "data": [{"id": "444444444", "name": "My Personal Page", "category": "Personal", "fan_count": 50}]
        }
    ...
    async def test_get_account_pages_tracking_specs_discovery(self):
        ...
        mock_ads_data = {"data": [{"id": "ad_123", "tracking_specs": [{"page": ["555555555", "666666666"]}]}]}
    ...
    async def test_get_account_pages_act_prefix_handling(self):
        ...
        with (
            ...
            await get_account_pages(account_id="123456789")
