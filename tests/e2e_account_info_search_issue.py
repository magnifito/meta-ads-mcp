...
class TestAccountInfoSearchIssue:
    ...
    def test_get_ad_accounts_can_see_target_account(self):
        ...
        try:
            ...
            result_data = {
                ...
                "all_account_ids": [
                    acc.get("id", "").replace("act_", "") for acc in accounts if isinstance(acc, dict) and acc.get("id")
                ],
            }

            print("✅ get_ad_accounts results:")
    ...
    def test_get_account_info_cannot_find_target_account(self):
        ...
        params = {"name": "get_account_info", "arguments": {"account_id": self.target_account_id}}
        ...
        try:
            ...
            print("✅ get_account_info results:")
...
def run_validation():
    ...
    print("Target Account ID: 414174661097171")
    print("=" * 60)
    ...
    if accounts_result["success"]:
        ...
        if accounts_result["target_account_found"]:
            print("✅ get_ad_accounts: Target account 414174661097171 IS visible")
        else:
            print("❌ get_ad_accounts: Target account 414174661097171 is NOT visible")
    ...
    if account_info_result["success"]:
        if account_info_result["has_error"]:
            ...
            print("✅ get_account_info: Successfully found account")
    else:
        print(f"❌ get_account_info: Test failed - {account_info_result['error']}")

    # Determine if issue is confirmed
    issue_confirmed = (
        accounts_result.get("success", False)
        and accounts_result.get("target_account_found", False)
        and account_info_result.get("success", False)
        and account_info_result.get("has_error", False)
    )
