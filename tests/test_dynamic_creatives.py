...
class TestDynamicCreatives:
    ...
    async def test_create_ad_creative_single_headline(self):
        ...
        sample_creative_data = {"id": "123456789", "name": "Test Creative", "status": "ACTIVE"}
    ...
    async def test_create_ad_creative_dynamic_creative_spec(self):
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            result = await create_ad_creative(
                ...
                headlines=["Headline 1", "Headline 2"],
                descriptions=["Description 1", "Description 2"],
                dynamic_creative_spec={"headline_optimization": True, "description_optimization": True},
                call_to_action_type="LEARN_MORE",
            )
    ...
    async def test_update_ad_creative_add_headlines(self):
        ...
        sample_creative_data = {"id": "123456789", "name": "Updated Creative", "status": "ACTIVE"}
    ...
    async def test_update_ad_creative_update_dynamic_spec(self):
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            result = await update_ad_creative(
                access_token="test_token",
                creative_id="123456789",
                dynamic_creative_spec={"headline_optimization": True, "description_optimization": False},
            )
    ...
    async def test_update_ad_creative_validation_max_headlines(self):
        ...
        result = await update_ad_creative(
            access_token="test_token", creative_id="123456789", headlines=too_many_headlines
        )
    ...
    async def test_update_ad_creative_validation_max_descriptions(self):
        ...
        result = await update_ad_creative(
            access_token="test_token", creative_id="123456789", descriptions=too_many_descriptions
        )
    ...
    async def test_update_ad_creative_validation_headline_length(self):
        ...
        result = await update_ad_creative(access_token="test_token", creative_id="123456789", headlines=[long_headline])
    ...
    async def test_update_ad_creative_validation_description_length(self):
        ...
        result = await update_ad_creative(
            access_token="test_token", creative_id="123456789", descriptions=[long_description]
        )
    ...
    async def test_update_ad_creative_name_only(self):
        ...
        sample_creative_data = {"id": "123456789", "name": "Updated Creative Name", "status": "ACTIVE"}

        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            mock_api.return_value = sample_creative_data

            result = await update_ad_creative(
                access_token="test_token", creative_id="123456789", name="Updated Creative Name"
            )
    ...
    async def test_update_ad_creative_message_only(self):
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            result = await update_ad_creative(
                access_token="test_token", creative_id="123456789", message="Updated message text"
            )
    ...
    async def test_update_ad_creative_cta_without_dynamic_content(self):
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            result = await update_ad_creative(
                access_token="test_token", creative_id="123456789", call_to_action_type="LEARN_MORE"
            )
    ...
    async def test_update_ad_creative_combined_updates(self):
        ...
        sample_creative_data = {"id": "123456789", "name": "Multi-Updated Creative", "status": "ACTIVE"}
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            assert creative_data["asset_feed_spec"]["descriptions"] == [{"text": "New Description 1"}]
            assert creative_data["asset_feed_spec"]["bodies"] == [{"text": "Updated message"}]
    ...
    async def test_update_ad_creative_api_error_handling(self):
        ...
        with patch("meta_ads_mcp.core.ads.make_api_request", new_callable=AsyncMock) as mock_api:
            ...
            result = await update_ad_creative(access_token="test_token", creative_id="123456789", name="Test Creative")
